...
[![Density and number of stream fields of the Zel'dovich approximation and an $N$-body simulation.](assets/figures/density.svg)](https://github.com/jfeldbrugge/Nbody2D.jl/docs/src/assets/figures/density.svg)
